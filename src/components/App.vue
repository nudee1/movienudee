...
<script>
  ...
  const config = {
    apiKey: 'AIzaSyAkfm1G-wieDrW5fhtuz6tMMKOCBcGfLgw',
    authDomain: 'movie-b2b16.firebaseapp.com',
    databaseURL: 'https://movie-b2b16.firebaseio.com',
    projectId: 'movie-b2b16',
    storageBucket: 'movie-b2b16.appspot.com',
    messagingSenderId: '816457110374'
  }
